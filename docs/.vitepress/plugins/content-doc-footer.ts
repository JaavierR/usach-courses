...
export function ContentDocFooter(): Plugin {
  return {
    name: "content-doc-footer",
    enforce: "pre",
    transform(code, id) {
      if (id.includes("VPContentDocFooter.vue") && !id.endsWith(".css")) {
        return `
              ...
              <template>
                <footer v-if="links.prev || links.next" class="VPContentDocFooter">
                  ...
                  >
                    <span class="desc"
                      ><VTIconChevronLeft class="vt-link-icon" /> Anterior</span
                    >
                  ...
                  >
                    <span class="desc">Siguiente <VTIconChevronRight class="vt-link-icon" /></span>

...
export function DocFooter(): Plugin {
  return {
    name: "doc-footer",
    enforce: "pre",
    transform: (code, id) => {
      if (id.includes("VPDocFooter.vue") && !id.endsWith(".css")) {
        return `
                    ...
                    <footer v-if="control.prev || control.next" class="VPDocFooter">
                        ...
                        <div class="pager">
                            ...
                            <span class="desc">Página anterior</span>
                        ...
                        <div class="pager" :class="{ 'has-prev': control.prev }">
                            ...
                            <span class="desc">Página siguiente</span>
